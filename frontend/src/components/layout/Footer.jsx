        ...
        <div className="grid grid-cols-[2fr_1fr_1fr_1fr] gap-11 mb-11">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-3">
              <div className="w-9 h-9 bg-vnpt rounded-lg flex items-center justify-content-center flex items-center justify-center">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/VNPT_Logo.svg/512px-VNPT_Logo.svg.png" alt="VNPT" className="w-6 brightness-0 invert"/>
              </div>
            ...
            <div className="flex gap-2">
              {['f','▶','T','in'].map(s => (
                <a key={s} href="#" className="w-8 h-8 bg-white/8 border border-white/10 rounded-lg flex items-center justify-center text-white/50 text-sm hover:bg-vnpt hover:text-white hover:border-vnpt transition-all">
                  {s}
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={to}><Link to={to} className="text-sm text-white/50 hover:text-white transition-colors">{label}</Link></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={label}><Link to={to} className="text-sm text-white/50 hover:text-white transition-colors">{label}</Link></li>
              ))}
            </ul>
          </div>
        </div>
