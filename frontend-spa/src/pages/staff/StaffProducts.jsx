  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center gap-2 px-4 py-2.5 bg-amber-50 border border-amber-200 rounded-xl text-xs text-amber-700 font-semibold">
        👁️ Chế độ xem — Thêm, sửa, xoá sản phẩm chỉ dành cho Quản trị viên
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        />
        <span className="text-sm text-muted">Tổng: <strong className="text-body">{total}</strong> sản phẩm</span>
      </div>
