      ...
      <div className="max-w-[1200px] mx-auto px-10 py-8 grid grid-cols-[260px_minmax(0,1fr)] gap-7 items-start min-h-[calc(100vh-180px)]">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center justify-between gap-3 mb-4 min-h-[32px]">
            ...
            {/* Nút xoá — chiếm đúng chiều cao của SortDropdown để căn đều */}
            <button
              onClick={clearFilters}
              className={`flex-shrink-0 inline-flex items-center gap-1 border border-accent text-accent text-xs font-semibold px-3 py-1.5 rounded-full hover:bg-accent hover:text-white transition-all ${hasActiveFilters ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}
            >
              ✕ Xoá bộ lọc
            </button>
          </div>
