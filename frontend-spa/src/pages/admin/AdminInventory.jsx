...
export default function AdminInventory() {
  ...
  // tham số stock_status mà backend GET /inventory đã hỗ trợ sẵn nhưng UI
  // trước đây chưa có ô lọc riêng (chỉ 3 thẻ thống kê phía trên hiển thị,
  // không bấm lọc bảng được).
